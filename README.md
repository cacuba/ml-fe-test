# Front-end Test - Caio Batista

This front-end test was based on CHICO UI following all instructions received.

Parts not-used of Chico was removed, like examples, images & etc.

CSS & JS styleguides was followed.

The page is responsible.

## Paths

- /src/product/index.html > main html file
- /src/product/scripts > custom js
- /src/product/styles/product-theme > product page css style sheets 
- /dist > folder with final files and minified scripts
